...
[opencode-template](https://github.com/opencode-ai/opencode-template) and now
 tailored to Pi + Pi Fabric: 9 prompt commands, 123 skill files
 (112 leaves in 11 packs: 108 pack leaves + 4 core safety), 12 format templates, Pi-native settings, and the
...
├── skills/                # 123 skill files: 11 pack routers + 104 pack leaves + 4 core safety
...
- Skills: 123 skill files — 11 pack routers, 104 hidden pack leaves, and 4 core safety skills (brainstorming, debugging-and-error-recovery, security-and-hardening, verification-before-completion) under `.pi/skills/`.
