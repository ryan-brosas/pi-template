...
[opencode-template](https://github.com/opencode-ai/opencode-template) and now
 tailored to Pi + Pi Fabric: 9 prompt commands, 124 skill files
 (113 leaves in 11 packs: 109 pack leaves + 4 core safety), 12 format templates, Pi-native settings, and the
...
├── skills/                # 124 skill files: 11 pack routers + 106 pack leaves + 4 core safety
...
- Skills: 124 skill files — 11 pack routers, 106 hidden pack leaves, and 4 core safety skills (brainstorming, debugging-and-error-recovery, security-and-hardening, verification-before-completion) under `.pi/skills/`.
