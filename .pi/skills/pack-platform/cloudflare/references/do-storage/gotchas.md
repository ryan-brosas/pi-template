...
// [x] SAFE: Response waits for write confirm; if write fails, response discarded & restart
async increment() {
...
// [x] CORRECT: Use transactionSync() or async transaction()
