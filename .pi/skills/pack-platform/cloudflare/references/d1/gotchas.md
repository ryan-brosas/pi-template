...
- [x] Use prepared statements with bind() - ALWAYS
- [x] Create indexes on frequently queried columns
- [x] Use batch() for multiple queries (reduces latency)
- [x] Design for horizontal scaling (multiple small DBs vs single large DB)
- [x] Test migrations locally before applying remotely
- [x] Monitor query performance via meta.duration
