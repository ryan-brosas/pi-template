...
[x] Fix: Always run baseline scenarios first.

**[ ] Not watching test fail properly**
Running only academic tests, not real pressure scenarios.
[x] Fix: Use pressure scenarios that make agent WANT to violate.

**[ ] Weak test cases (single pressure)**
Agents resist single pressure, break under multiple.
[x] Fix: Combine 3+ pressures (time + sunk cost + exhaustion).

**[ ] Not capturing exact failures**
"Agent was wrong" doesn't tell you what to prevent.
[x] Fix: Document exact rationalizations verbatim.

**[ ] Vague fixes (adding generic counters)**
"Don't cheat" doesn't work. "Don't keep as reference" does.
[x] Fix: Add explicit negations for each specific rationalization.

**[ ] Stopping after first pass**
Tests pass once ≠ bulletproof.
[x] Fix: Continue REFACTOR cycle until no new rationalizations.
