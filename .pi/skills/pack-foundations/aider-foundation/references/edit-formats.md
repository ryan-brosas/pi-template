...
**Source:** Aider MIT `main@5dc9490bb35f9729ef2c95d00a19ccd30c26339c`; Codebase Memory project `aider` (full index). **Question:** How does a harness apply model-authored SEARCH/REPLACE blocks without corrupting the file on a near-miss edit?
