...
**Source:** Aider MIT `main@5dc9490bb35f9729ef2c95d00a19ccd30c26339c`; Codebase Memory project `aider`. **Question:** How can an agent loop turn post-edit diagnostics into a bounded, actionable repair message without dropping the failed tool output or flooding the model with a whole file?
