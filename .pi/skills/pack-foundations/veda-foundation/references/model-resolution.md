...
**Retrieve:**
```ts
await mcp.codebase_memory.search_graph({ project: "veda", query: "resolveBackendModelExtracted determineBackend inferBackendFromModel", limit: 10, fields: ["signature", "name", "file"] });
```
