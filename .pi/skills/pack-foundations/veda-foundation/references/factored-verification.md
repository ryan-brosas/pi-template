...
**Retrieve:**
```ts
await mcp.codebase_memory.search_graph({ project: "veda", query: "runVerification runGenerateChecks runAnswerChecks parseChecks", limit: 10, fields: ["signature", "name", "file"] });
```
