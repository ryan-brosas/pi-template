# Gemini CLI Large Context — Operational Reference

Load this reference only after the gemini-large-context leaf matches. It holds the command syntax, research patterns, and configuration.
