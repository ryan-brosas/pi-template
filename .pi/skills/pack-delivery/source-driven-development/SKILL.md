...
This is a delivery-time gate, not a research workflow. Discovery belongs to `pack-research`; this skill only enforces the rule that non-trivial external decisions are not shipped on a guess.
...
## Route Discovery to pack-research
