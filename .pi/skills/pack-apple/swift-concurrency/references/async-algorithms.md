...
Remove adjacent duplicates. **Stable operator [x]**
...
Collect values into batches. **Stable operator [x]**
...
AsyncSequence with backpressure. **Stable operator [x]**
...
Like AsyncChannel but can emit errors. **Stable operator [x]**
