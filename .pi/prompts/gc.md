...
- **Generated state**: `.pi/MEMORY.md`, `.pi/implementation-notes.md`, `.pi/work/.active`, per-work `.progress.md`/`.verify.log`, `.pi/work/ide-inspections/`, `.pi/fabric/` contents that can be regenerated.
