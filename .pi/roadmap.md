...
| Skill catalog      | Pack catalog, ledger, and frontmatter agree                                                    | `node scripts/validate-skill-packs.mjs` exits 0; 11 packs, 116 leaves, 15 visible, metadata under the 1,200-token budget |
